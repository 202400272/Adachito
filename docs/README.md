# AdaShimaverse Documentation

This directory contains the project documentation for developers and contributors.

## Documentation map

- [Architecture](ARCHITECTURE.md) — how the site is structured and how its pieces fit together.
- [Data](DATA.md) — the JSON-driven content layer and catalogue data conventions.
